  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-indigo-500 rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        <div className='md:w=1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            <p className='text-3xl md:text-4xl lg:text-5xl text-white font-semibold leaing-tight md:leading-tight lg:leading-tight'>Book Appointment <br/>With Trusted Doctors</p>
            ...
            <a href='#speciality' className='pl-4 pr-4 flex items-center gap-2 bg-white py-3 rounded-full taxt-gray-600 text-sm m-auto md:m-0 hover:scale-105 trasition-allduration-300'>

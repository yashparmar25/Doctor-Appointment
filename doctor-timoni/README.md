...
A [timoni.sh](http://timoni.sh) module for deploying doctor to Kubernetes clusters.
...
```shell
timoni -n default apply doctor oci://<container-registry-url>
```
...
```shell
timoni -n default delete doctor
```

        ...
        <div>
            ...
            <div className='my-10 flex flex-col md:flex-row gap-12'>
                ...
                <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
                    ...
                    <p>Prescripto Is Committed To Excellence in Healthcare Technology. We Continuously Strive To Enhance Our I Platform, Integrating The Latest Advancements To Improve User Experience And Deliver Superior Service Whether You're Booking Your First Appointment Or Managing Ongoing Care, Prescripto is Here To Support You Every Step Of The Way.
                    </p>
            ...
            <div className='flex flex-col md:flex-row mb-20'>
                <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col  gap-5 text-[15px] hover:bg-indigo-500 hover:text-white trasition-all duration-300 text-gray-600 cursor-pointer'>
                    <b>EFFICIENCY:</b>
